<h3>Mantenimiento de Modelos</h3>
    <p>
        <a href="index.php?b=backend&c=modelos&a=add" title="Crear"><img src="Public/img/increase.png" /></a>&nbsp;
    ...
    <table class="table1">
        ...
        <tbody>
            ...
            <tr>
                    <td><a href="index.php?b=backend&c=modelos&a=edit&p=<?php echo $modelo->getId(); ?>" title="Editar"><img src="Public/img/notebook_edit.png" /></a></td>
                    <td>
                        <a 
