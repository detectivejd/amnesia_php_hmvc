...
<table class="table1">
    ...
    <tbody>
        <?php foreach ($pagos as $pago) { ?>
            <tr>
                <td><a href="index.php?c=pagos&a=delete&p=<?php echo \App\Session::get('id'); ?>&pag=<?php echo $pago->getId(); ?>" onclick="return confirm('¿Desea Borrar el Pago Seleccionado?');" title="Eliminar"><img src="Public/img/erase.png" /></a></td>
