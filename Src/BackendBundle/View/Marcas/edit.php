    <form method="post" name="frmedit_mar" action="index.php?b=backend&c=marcas&a=edit&p=<?php echo \App\Session::get('id'); ?>">
        <table>
            <tr>
        ...
        <p>
            ...
            <a href="index.php?b=backend&c=marcas&a=index"><input type="button" value="Cancelar" name="btncancelar" /></a>            
        </p>
    </form>