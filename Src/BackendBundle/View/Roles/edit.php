    <form method="post" name="frmedit_rol" action="index.php?b=backend&c=roles&a=edit&p=<?php echo \App\Session::get('id'); ?>">
        <table>
            <tr>
        ...
        <p>
            ...
            <a href="index.php?b=backend&c=roles&a=index"><input type="button" value="Cancelar" name="btncancelar" /></a>            
        </p>
    </form>